...
public class CYTipAlertViewController: UIViewController {
...
extension CYTipAlertViewController {
    ...
    public static func createNormalAlertView(_ title: String?, _ sureText: String? = "确定") -> CYTipAlertViewController {
